...
public class ImageAssessmentActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image = (ImageView) findViewById(resources.getIdentifier("textview", "id", package_name));
        preview = (SurfaceView) findViewById(resources.getIdentifier("surface", "id", package_name));
